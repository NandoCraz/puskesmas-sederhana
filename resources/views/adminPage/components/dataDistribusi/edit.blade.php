        ...
        <div class="col-lg-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="/master/data-distribusi/{{ $distribusi->id }}">
                        @method('put')
                        @csrf
                        <div class="mb-4">
                            ...
                            <select class="form-control" id="penerima" name="id_penerima">
                                ...
                                @foreach ($penerimas as $penerima)
                                    <option value="{{ $penerima->id }}"
                                        {{ $distribusi->id_penerima == $penerima->id ? 'selected' : '' }}>
                                        {{ $penerima->nama_instansi }}
                                    </option>
                                @endforeach
                            </select>
                            @error('id_penerima')
                            ...
                            <select class="form-control" id="obat" name="id_obat">
                                ...
                                @foreach ($obats as $obat)
                                    <option value="{{ $obat->id }}"
                                        {{ $distribusi->id_obat == $obat->id ? 'selected' : '' }}>{{ $obat->nama_obat }}
                                    </option>
                                @endforeach
                            </select>
                            @error('id_obat')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <input class="form-control selector" type="text" id="tanggal_terima"
                                    name="tanggal_terima" value="{{ $distribusi->tanggal_terima }}" autocomplete="off"
                                    required>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input class="form-control @error('jumlah_terima') is-invalid @enderror" id="jumlah_terima"
                                type="number" name="jumlah_terima" value="{{ $distribusi->jumlah_terima }}" required
                                autocomplete="off">
                            @error('jumlah_terima')
                                <div class="invalid-feedback">
                                    {{ $message }}
